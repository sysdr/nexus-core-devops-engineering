        ...
        pub mod wall_clock {
            ...
            pub fn now() -> Datetime {
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "wasi:clocks/wall-clock@0.2.8")]
                    extern "C" {
                        #[link_name = "now"]
        ...
        pub mod agent {
            ...
            pub mod react_agent {
                ...
                pub struct StepResult {
                    pub thought: _rt::String,
                    pub action: Option<_rt::String>,
                    pub action_input: Option<_rt::String>,
                    pub observation: Option<_rt::String>,
                    pub final_answer: Option<_rt::String>,
                    pub step_index: u32,
                }
                impl ::core::fmt::Debug for StepResult {
                    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                        f.debug_struct("StepResult")
                            ...
                            .field("action-input", &self.action_input)
                            .field("observation", &self.observation)
                            .field("final-answer", &self.final_answer)
                            .field("step-index", &self.step_index)
                            .finish()
                    }
                }
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_run_step_cabi<T: Guest>(
                    arg0: *mut u8,
                    arg1: usize,
                    arg2: *mut u8,
                    arg3: usize,
                    ...
                    for i in 0..len21 {
                        ...
                        let e21 = {
                            ...
                            let l16 = i32::from(*base.add(44).cast::<u8>());
                            let l20 = *base.add(56).cast::<i32>();

                            StepResult {
                                thought: _rt::string_lift(bytes3),
                                action: match l4 {
                                    0 => None,
                                    1 => {
                                        let e = {
                                ...
                                step_index: l20 as u32,
                            }
                        };
                        result21.push(e21);
                    }
                    _rt::cabi_dealloc(base21, len21 * 60, 4);
                    let len22 = arg5;
                    let bytes22 = _rt::Vec::from_raw_parts(arg4.cast(), len22, len22);
                    let len23 = arg7;
                    let bytes23 = _rt::Vec::from_raw_parts(arg6.cast(), len23, len23);
                    let len24 = arg9;
                    let bytes24 = _rt::Vec::from_raw_parts(arg8.cast(), len24, len24);
                    let result25 = T::run_step(
                        ...
                        Ok(e) => {
                            *ptr26.add(0).cast::<u8>() = (0i32) as u8;
                            let StepResult {
                                thought: thought27,
                                action: action27,
                                action_input: action_input27,
                                observation: observation27,
                                final_answer: final_answer27,
                                step_index: step_index27,
                            } = e;
                            let vec28 = (thought27.into_bytes()).into_boxed_slice();
                            let ptr28 = vec28.as_ptr().cast::<u8>();
                            let len28 = vec28.len();
                            ...
                            *ptr26.add(4).cast::<*mut u8>() = ptr28.cast_mut();
                            match action27 {
                                Some(e) => {
                                    *ptr26.add(12).cast::<u8>() = (1i32) as u8;
                                    let vec29 = (e.into_bytes()).into_boxed_slice();
                                    let ptr29 = vec29.as_ptr().cast::<u8>();
                                    let len29 = vec29.len();
                                    ::core::mem::forget(vec29);
                                    *ptr26.add(20).cast::<usize>() = len29;
                                    *ptr26.add(16).cast::<*mut u8>() = ptr29.cast_mut();
                                }
                                None => {
                                    *ptr26.add(12).cast::<u8>() = (0i32) as u8;
                                }
                            };
                            match action_input27 {
                                Some(e) => {
                                    *ptr26.add(24).cast::<u8>() = (1i32) as u8;
                                    let vec30 = (e.into_bytes()).into_boxed_slice();
                                    let ptr30 = vec30.as_ptr().cast::<u8>();
                                    let len30 = vec30.len();
                                    ::core::mem::forget(vec30);
                                    *ptr26.add(32).cast::<usize>() = len30;
                                    *ptr26.add(28).cast::<*mut u8>() = ptr30.cast_mut();
                                }
                                None => {
                                    *ptr26.add(24).cast::<u8>() = (0i32) as u8;
                                }
                            };
                            match observation27 {
                                Some(e) => {
                                    *ptr26.add(36).cast::<u8>() = (1i32) as u8;
                                    let vec31 = (e.into_bytes()).into_boxed_slice();
                                    let ptr31 = vec31.as_ptr().cast::<u8>();
                                    let len31 = vec31.len();
                                    ::core::mem::forget(vec31);
                                    *ptr26.add(44).cast::<usize>() = len31;
                                    *ptr26.add(40).cast::<*mut u8>() = ptr31.cast_mut();
                                }
                                None => {
                                    *ptr26.add(36).cast::<u8>() = (0i32) as u8;
                                }
                            };
                            match final_answer27 {
                                Some(e) => {
                                    *ptr26.add(48).cast::<u8>() = (1i32) as u8;
                                    let vec32 = (e.into_bytes()).into_boxed_slice();
                                    let ptr32 = vec32.as_ptr().cast::<u8>();
                                    let len32 = vec32.len();
                                    ::core::mem::forget(vec32);
                                    *ptr26.add(56).cast::<usize>() = len32;
                                    *ptr26.add(52).cast::<*mut u8>() = ptr32.cast_mut();
                                }
                                None => {
                                    *ptr26.add(48).cast::<u8>() = (0i32) as u8;
                                }
                            };
                            *ptr26.add(60).cast::<i32>() = _rt::as_i32(step_index27);
                        }
                        Err(e) => {
                            ...
                            *ptr26.add(8).cast::<usize>() = len33;
                            *ptr26.add(4).cast::<*mut u8>() = ptr33.cast_mut();
                        }
                    };
                    ptr26
                }
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_run_step<T: Guest>(arg0: *mut u8) {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_reset_arena_cabi<T: Guest>() {
                    #[cfg(target_arch = "wasm32")]
                    _rt::run_ctors_once();
                    T::reset_arena();
                }
                pub trait Guest {
                    ...
                    fn run_step(
                        query: _rt::String,
                        history: _rt::Vec<StepResult>,
                        llm_endpoint: _rt::String,
                        search_endpoint: _rt::String,
                        api_key: _rt::String,
                    ) -> Result<StepResult, _rt::String>;
                    /// Reset the internal bump allocator arena between runs.
                    fn reset_arena();
                }
                #[doc(hidden)]

                macro_rules! __export_nexuscore_agent_react_agent_0_1_0_cabi{
      ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

        #[export_name = "nexuscore:agent/react-agent@0.1.0#run-step"]
        unsafe extern "C" fn export_run_step(arg0: *mut u8,arg1: usize,arg2: *mut u8,arg3: usize,arg4: *mut u8,arg5: usize,arg6: *mut u8,arg7: usize,arg8: *mut u8,arg9: usize,) -> *mut u8 {
          $($path_to_types)*::_export_run_step_cabi::<$ty>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9)
        }
        #[export_name = "cabi_post_nexuscore:agent/react-agent@0.1.0#run-step"]
        unsafe extern "C" fn _post_return_run_step(arg0: *mut u8,) {
          $($path_to_types)*::__post_return_run_step::<$ty>(arg0)
        }
        #[export_name = "nexuscore:agent/react-agent@0.1.0#reset-arena"]
        unsafe extern "C" fn export_reset_arena() {
          $($path_to_types)*::_export_reset_arena_cabi::<$ty>()
        }
      };);
    }
                #[doc(hidden)]
                pub(crate) use __export_nexuscore_agent_react_agent_0_1_0_cabi;
                #[repr(align(4))]
...
macro_rules! __export_agent_world_impl {
  ...
  $($path_to_types_root)*::exports::nexuscore::agent::react_agent::__export_nexuscore_agent_react_agent_0_1_0_cabi!($ty with_types_in $($path_to_types_root)*::exports::nexuscore::agent::react_agent);
  )
}
#[doc(inline)]
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.25.0:agent-world:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 6882] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xe04\x01A\x02\x01A\x19\
...
\x01\x12wasi:io/poll@0.2.8\x05\0\x02\x03\0\0\x08pollable\x01B\x0f\x02\x03\x02\x01\
...
cks/monotonic-clock@0.2.8\x05\x02\x01B\x04\x04\0\x05error\x03\x01\x01h\0\x01@\x01\
\x04self\x01\0s\x04\0\x1d[method]error.to-debug-string\x01\x02\x03\x01\x13wasi:i\
o/error@0.2.8\x05\x03\x02\x03\0\x02\x05error\x01B(\x02\x03\x02\x01\x04\x04\0\x05\
...
wasi:io/streams@0.2.8\x05\x05\x02\x03\0\x01\x08duration\x02\x03\0\x03\x0cinput-s\
tream\x02\x03\0\x03\x0doutput-stream\x01B\xc4\x01\x02\x03\x02\x01\x06\x04\0\x08d\
...
method]request-options.set-between-bytes-timeout\x01`\x01h)\x01j\0\x01\x1b\x01@\x03\
\x04self\xe1\0\x06status{\x07headers\xc7\0\0\xe2\0\x04\0,[method]response-outpar\
am.send-informational\x01c\x01i)\x01i/\x01j\x01\xe5\0\x01\x1b\x01@\x02\x05param\xe4\
\0\x08response\xe6\0\x01\0\x04\0\x1d[static]response-outparam.set\x01g\x01h,\x01\
@\x01\x04self\xe8\0\0+\x04\0\x20[method]incoming-response.status\x01i\x01@\x01\x04\
self\xe8\0\0\xc7\0\x04\0![method]incoming-response.headers\x01j\x01@\x01\x04self\
\xe8\0\0\xca\0\x04\0![method]incoming-response.consume\x01k\x01h-\x01i\x03\x01j\x01\
\xed\0\0\x01@\x01\x04self\xec\0\0\xee\0\x04\0\x1c[method]incoming-body.stream\x01\
o\x01i.\x01@\x01\x04this\xc9\0\0\xf0\0\x04\0\x1c[static]incoming-body.finish\x01\
q\x01h.\x01i\x09\x01@\x01\x04self\xf2\0\0\xf3\0\x04\0![method]future-trailers.su\
bscribe\x01t\x01i%\x01k\xf5\0\x01j\x01\xf6\0\x01\x1b\x01j\x01\xf7\0\0\x01k\xf8\0\
\x01@\x01\x04self\xf2\0\0\xf9\0\x04\0\x1b[method]future-trailers.get\x01z\x01@\x01\
\x07headers\xc7\0\0\xe5\0\x04\0\x1e[constructor]outgoing-response\x01{\x01h/\x01\
@\x01\x04self\xfc\0\0+\x04\0%[method]outgoing-response.status-code\x01}\x01@\x02\
\x04self\xfc\0\x0bstatus-code+\0\xd3\0\x04\0)[method]outgoing-response.set-statu\
s-code\x01~\x01@\x01\x04self\xfc\0\0\xc7\0\x04\0![method]outgoing-response.heade\
rs\x01\x7f\x01@\x01\x04self\xfc\0\0\xd0\0\x04\0\x1e[method]outgoing-response.bod\
y\x01\x80\x01\x01h0\x01i\x05\x01j\x01\x82\x01\0\x01@\x01\x04self\x81\x01\0\x83\x01\
\x04\0\x1b[method]outgoing-body.write\x01\x84\x01\x01@\x02\x04this\xcf\0\x08trai\
lers\xf6\0\0\xe2\0\x04\0\x1c[static]outgoing-body.finish\x01\x85\x01\x01h1\x01@\x01\
\x04self\x86\x01\0\xf3\0\x04\0*[method]future-incoming-response.subscribe\x01\x87\
\x01\x01i,\x01j\x01\x88\x01\x01\x1b\x01j\x01\x89\x01\0\x01k\x8a\x01\x01@\x01\x04\
self\x86\x01\0\x8b\x01\x04\0$[method]future-incoming-response.get\x01\x8c\x01\x01\
h\x07\x01k\x1b\x01@\x01\x03err\x8d\x01\0\x8e\x01\x04\0\x0fhttp-error-code\x01\x8f\
\x01\x03\x01\x15wasi:http/types@0.2.8\x05\x09\x02\x03\0\x04\x10outgoing-request\x02\
\x03\0\x04\x0frequest-options\x02\x03\0\x04\x18future-incoming-response\x02\x03\0\
\x04\x0aerror-code\x01B\x0f\x02\x03\x02\x01\x0a\x04\0\x10outgoing-request\x03\0\0\
\x02\x03\x02\x01\x0b\x04\0\x0frequest-options\x03\0\x02\x02\x03\x02\x01\x0c\x04\0\
\x18future-incoming-response\x03\0\x04\x02\x03\x02\x01\x0d\x04\0\x0aerror-code\x03\
\0\x06\x01i\x01\x01i\x03\x01k\x09\x01i\x05\x01j\x01\x0b\x01\x07\x01@\x02\x07requ\
est\x08\x07options\x0a\0\x0c\x04\0\x06handle\x01\x0d\x03\x01\x20wasi:http/outgoi\
ng-handler@0.2.8\x05\x0e\x01B\x05\x01r\x02\x07secondsw\x0bnanosecondsy\x04\0\x08\
datetime\x03\0\0\x01@\0\0\x01\x04\0\x03now\x01\x02\x04\0\x0aresolution\x01\x02\x03\
\x01\x1cwasi:clocks/wall-clock@0.2.8\x05\x0f\x01B\x09\x01ks\x01r\x06\x07thoughts\
\x06action\0\x0caction-input\0\x0bobservation\0\x0cfinal-answer\0\x0astep-indexy\
\x04\0\x0bstep-result\x03\0\x01\x01p\x02\x01j\x01\x02\x01s\x01@\x05\x05querys\x07\
history\x03\x0cllm-endpoints\x0fsearch-endpoints\x07api-keys\0\x04\x04\0\x08run-\
step\x01\x05\x01@\0\x01\0\x04\0\x0breset-arena\x01\x06\x04\x01!nexuscore:agent/r\
eact-agent@0.1.0\x05\x10\x04\x01!nexuscore:agent/agent-world@0.1.0\x04\0\x0b\x11\
